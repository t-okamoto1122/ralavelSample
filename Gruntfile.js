// Generated on 2015-04-16 using generator-jhipster 2.7.0
'use strict';
var fs = require('fs');
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        typescript: {
	        ...
	        client: {
	            src: ['src/main/webapp/ts/client/index.ts'],
	            dest: 'src/main/webapp/scripts/app/client/typescript.js'
	        },
	        manager: {
	            src: ['src/main/webapp/ts/manager/index.ts'],
	            dest: 'src/main/webapp/scripts/app/manager/typescript.js'
	        },
            demo: {
                src: ['src/main/webapp/ts/demo/index.ts'],
                dest: 'src/main/webapp/scripts/app/demo/typescript.js'
            }
        },
        watch: {
        	typescript: {
        		files: ['src/main/webapp/ts/**/*.ts'],
        		tasks: ['typescript:client','typescript:manager','typescript:demo']
        	},
            bower: {
                files: ['bower.json'],
                tasks: ['wiredep']
        ...
        wiredep: {
            app: {
                src: ['src/main/webapp/vendorjs.html','src/main/webapp/vendorcss.html','src/main/webapp/client.html','src/main/webapp/manager.html','src/main/webapp/demo.html'],
                exclude: [
        ...
        useminPrepare: {
            //html: 'src/main/webapp/**/*.html', dev/**,demo.htmlのせいでエラーになるので個別定義・・。
            html:[
                'src/main/webapp/scripts/**/*.html',
                'src/main/webapp/swagger-ui/**/*.html',
                'src/main/webapp/manager.html',
                'src/main/webapp/client.html',
                'src/main/webapp/demo.html',
                'src/main/webapp/vendorcss.html',
                'src/main/webapp/vendorjs.html'
            ],
            options: {
                dest: '<%= yeoman.dist %>',
                flow: {
